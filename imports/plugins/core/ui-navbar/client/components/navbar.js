...
class NavBar extends Component {
  ...
  handleClick = (e) => {
    ...
    switch (e) {
      case "air":
        Reaction.Router.go("/categories/air-quality");
        break;
      case "footfall":
        Reaction.Router.go("/categories/footfall");
        break;
      case "noise":
        Reaction.Router.go("/categories/noise");
        break;
      default:
        break;
        // log some sort of user alert
  ...
  renderNavBarCategories () {
    return(
      <div className="">
        <nav className="">
          <span><a href="/" onClick={this.handleClick()} target="follow">Air Quality Data</a></span>
          <span><i> | </i><a href="/" onClick={this.handleClick()} target="follow">Footfall Data</a></span>
          <span><i> | </i><a href="/" onClick={this.handleClick()} target="follow">Noise Data</a></span>
        </nav>
      </div>
    )
  }
  ...
  render() {
    return (
      <div className="rui navbar">
        ...
        {this.props.visibility.categories && this.renderNavBarCategories()}
